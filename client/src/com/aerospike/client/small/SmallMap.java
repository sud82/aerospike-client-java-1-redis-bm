 ...
 */
public final class SmallMap {
	private static final String PackageName = "smap";
	 ...
	 */
	public SmallMap(AerospikeClient client, WritePolicy policy, Key key, String binName, String userModule) {
		this.client = client;
		this.policy = policy;
		this.key = key;
